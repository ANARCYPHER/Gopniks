...
int main(void) {
  ...
  ht_set(hashtable, "Сволочь", "Мочи перхоти");
  ht_set(hashtable, "Развалюха", "Жопа");
  ht_set(hashtable, "Жопа", "Ублюдок");
  ht_set(hashtable, "Гавно", "Трахни тебя");
  ht_set(hashtable, "лох", "Отыебис от меныа!");
  ht_set(hashtable, "чертовски дно", "Подви́нь жо́пу!");
  ht_set(hashtable, "Чушь собачья", "насра́ть");
  ht_set(hashtable, "хуёво", "обосра́ться");
  ht_set(hashtable, "hобосра́ться", "насра́ть");
  ht_set(hashtable, "хуй", "Отыебис от меныа!");
  ht_set(hashtable, "Чушь собачья", "Ти дегхенераат");
  ht_set(hashtable, "жо́па", "Трахни тебя");
